...
export class Persona extends MSerialisable {
   private _id: string;
   ...
   */
   ...
   set thumbnailB64(thumbNailB64_: string) {
      ...
      if (!Persona.isValidThumbnailB64(thumbNailB64_)) {
    ...
    */
   static isValidThumbnailB64(thumbNailB64_: string): boolean {
   ...
   static _notSignedIn: Persona = new Persona(null, "Not signed in", unknownImageB64, new Date(0));
   static _unknown: Persona = new Persona(null, "Unknown", unknownImageB64, new Date(0));
